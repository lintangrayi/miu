    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2023 - The Most Satisfying Store <a href="https://t.me/zeastuff" target="_blank">Zea Stuff</a></div></div>
        </footer>
